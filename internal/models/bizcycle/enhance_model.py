...
# refactor. The try/except keeps import-time failures from masking xgboost
# availability errors.
try:  # pragma: no cover - passthrough for legacy imports
    from .preprocess import backfill_missing_key_indicators
except Exception:
    backfill_missing_key_indicators = None
